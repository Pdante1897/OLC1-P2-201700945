...
yy: {},
symbols_: {"error":2,"INICIO":3,"coma":4,"$accept":0,"$end":1},
terminals_: {2:"error",4:"coma"},
productions_: [0,[3,2]],
...
table: [{3:1,4:[1,2]},{1:[3]},{4:[1,3]},{1:[2,1]}],
...
break;
case 32:return 'tochararray';
break;
case 33:return 'run';
break;
case 34:return 'aumento';
break;
...
case 51:return 'not';
break;
case 52:return 'salto';
break;
case 53:return 'barrainv';
break;
case 54:return 'comilladoble';
break;
case 55:return 'tabulacion';
break;
case 56:return 'comillasimple'
break;
case 57:return 4;
break;
case 58:return 'ptcoma';
break;
case 59:return 'dpuntos';
break;
case 60:return 'interrogacionc';
break;
case 61:return 'llavea';
break;
case 62:return 'llavec';
break;
case 63:return 'parentesisa';
break;
case 64:return 'parentisisc';
break;
case 65:return 'corchetea';
break;
case 66:return 'corchetec';
break;
...
rules: [/^(?:\s+)/i,/^(?:\/\/.*)/i,/^(?:[/][*][^*]*[*]+([^/*][^*]*[*]+)*[/])/i,/^(?:int\b)/i,/^(?:double\b)/i,/^(?:boolean\b)/i,/^(?:char\b)/i,/^(?:string\b)/i,/^(?:if\b)/i,/^(?:else\b)/i,/^(?:switch\b)/i,/^(?:case\b)/i,/^(?:default\b)/i,/^(?:print\b)/i,/^(?:println\b)/i,/^(?:while\b)/i,/^(?:for\b)/i,/^(?:do\b)/i,/^(?:break\b)/i,/^(?:continue\b)/i,/^(?:return\b)/i,/^(?:void\b)/i,/^(?:true\b)/i,/^(?:false\b)/i,/^(?:new\b)/i,/^(?:tolower\b)/i,/^(?:toupper\b)/i,/^(?:length\b)/i,/^(?:truncate\b)/i,/^(?:round\b)/i,/^(?:typeof\b)/i,/^(?:tostring\b)/i,/^(?:tochararray\b)/i,/^(?:run\b)/i,/^(?:\+\+)/i,/^(?:--)/i,/^(?:==)/i,/^(?:<=)/i,/^(?:>=)/i,/^(?:!=)/i,/^(?:<)/i,/^(?:>)/i,/^(?:\+)/i,/^(?:-)/i,/^(?:\*)/i,/^(?:\/)/i,/^(?:\^)/i,/^(?:%)/i,/^(?:=)/i,/^(?:\|\|)/i,/^(?:&&)/i,/^(?:!)/i,/^(?:\\n)/i,/^(?:\\\\)/i,/^(?:\\")/i,/^(?:\\t)/i,/^(?:\\')/i,/^(?:,)/i,/^(?:;)/i,/^(?::)/i,/^(?:\?)/i,/^(?:\{)/i,/^(?:\})/i,/^(?:\()/i,/^(?:\))/i,/^(?:\[)/i,/^(?:\])/i,/^(?:\.)/i,/^(?:["\""]([^"\""])*["\""])/i,/^(?:["\'"]([^"\'"])?["\'"])/i,/^(?:[0-9]+(\.[0-9]+)\b)/i,/^(?:[0-9]+\b)/i,/^(?:([a-zA-Z])[a-zA-Z0-9_]*)/i,/^(?:.)/i],
