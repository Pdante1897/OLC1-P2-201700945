...
function CicloDoUntil(_instruccion, _ambito) {
    ...
    var addError = {
        ...
        descripcion: "No es una expresion de tipo BOOLEAN en la condicion",
    ...
    return{
        existeBreak: existeBreak,
        expresionRetorno: expresionRetorno,
        cadena: `Error: No es una expresion de tipo BOOLEAN en la condicion... Linea: ${_instruccion.linea} Columna: ${_instruccion.columna}\n`
    }
}

module.exports = CicloDoUntil